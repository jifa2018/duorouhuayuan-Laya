...
export  class  MultiplePassOutlineMaterial extends Material {
    ...
    public static OUTLINECOLOR = Shader3D.propertyNameToID("u_OutlineColor");
    public static OUTLINEWIDTH = Shader3D.propertyNameToID("u_OutlineWidth");
    public static OUTLINELIGHTNESS = Shader3D.propertyNameToID("u_OutlineLightness");
